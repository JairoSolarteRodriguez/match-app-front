  ...
  if (search !== "") {
    result = ads.filter(
      (ad) =>
        ...
        ad.time.toLowerCase().includes(search) ||
  ...
  return (
    <>
      {pathname === "/home" || pathname === '/'? (
        <div className="section-location">
          <div className="unosec">
            ...
            <form
              className="form-section-search"
              onMouseEnter={() => setHideSearchBtn(true)}
              onMouseLeave={() => setHideSearchBtn(false)}
            ...
            >
              ...
              />
              <button
                style={{ display: hideSearchBtn ? "none" : "block" }}
                type="submit"
      ...
      <div className="container">
        {result.length === 0 ? (
          <p>Aún no hay datos que coincidan</p>
        ) : (
          result.map(
            ({
              id,
              ...
              <Link to={`/home/${id}`} key={id}>
                <Card
                  ...
                  days={days}
                  verified={verified}
                  detail={idUrl !== undefined ? false : true}
                />
              </Link>
            )
          )
